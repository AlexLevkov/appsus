    ...
    <div class="keep-create-note">
        ...
        <div class="create-note-btns">
            ...
            <div class="keep-design-btns">
                            ...
                            <button title="add note" class="add-note create-note-btn" @click="addNote"><i class="fa-regular fa-note-sticky fa-2x"></i></button>
                            <button title="add to do list" class="add-todo create-note-btn" @click="addTodo"><i class="fa-solid fa-list fa-2x"></i></button>
                            <button title="add image" class="add-img create-note-btn" @click="addImg"><i class="fa-regular fa-image fa-2x"></i></button>
                            <button title="add video" class="add-video create-note-btn" @click="addVideo"><i class="fa-brands fa-youtube fa-2x"></i></button>
